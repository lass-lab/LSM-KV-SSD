...
// Iterator Pool for Iteartor
#define ITER_POOL_START_ADDR			    (RESERVED1_START_ADDR)
#define ITER_POOL_SIZE					    (sizeof(struct _ITERATOR) * MAX_ITERATOR_NUM)

// #define ITER_MEMTABLE_BUFFER_START_ADDR     (ITER_POOL_START_ADDR + ITERATOR_POOL_SIZE)
// #define ITER_MEMTABLE_BUFFER_SIZE           (sizeof(struct _slice) * MAX_SKIPLIST_NODE)

// LSM-Tree State for Iterator
#define ITER_SUPER_SSTABLE_LEVEL0_START_ADDR      (ITER_POOL_START_ADDR + ITER_POOL_SIZE)
#define ITER_SUPER_SSTABLE_LEVEL0_SIZE            (MAX_SSTABLE_LEVEL0 * sizeof(struct _SUPER_SSTABLE_INFO) * MAX_ITERATOR_NUM)
#define ITER_SUPER_SSTABLE_LEVEL1_START_ADDR      (ITER_SUPER_SSTABLE_LEVEL0_START_ADDR + ITER_SUPER_SSTABLE_LEVEL0_SIZE) 
#define ITER_SUPER_SSTABLE_LEVEL1_SIZE            (MAX_SSTABLE_LEVEL1 * sizeof(struct _SUPER_SSTABLE_INFO) * MAX_ITERATOR_NUM)
#define ITER_SUPER_SSTABLE_LEVEL2_START_ADDR      (ITER_SUPER_SSTABLE_LEVEL1_START_ADDR + ITER_SUPER_SSTABLE_LEVEL1_SIZE) 
#define ITER_SUPER_SSTABLE_LEVEL2_SIZE            (MAX_SSTABLE_LEVEL2 * sizeof(struct _SUPER_SSTABLE_INFO) * MAX_ITERATOR_NUM)
#define ITER_SUPER_SSTABLE_LEVEL3_START_ADDR      (ITER_SUPER_SSTABLE_LEVEL2_START_ADDR + ITER_SUPER_SSTABLE_LEVEL2_SIZE) 
#define ITER_SUPER_SSTABLE_LEVEL3_SIZE            (MAX_SSTABLE_LEVEL3 * sizeof(struct _SUPER_SSTABLE_INFO) * MAX_ITERATOR_NUM)

// SSTable Index Buffer for Iterator
#define ITER_SSTABLE_LEVEL0_INDEX_BUFFER_START_ADDR    (ITER_SUPER_SSTABLE_LEVEL3_START_ADDR + ITER_SUPER_SSTABLE_LEVEL3_SIZE)
#define ITER_SSTABLE_LEVEL0_INDEX_BUFFER_SIZE          (sizeof(struct _SSTABLE_INDEX_NODE) * MAX_SKIPLIST_NODE * MAX_SSTABLE_LEVEL0 * MAX_ITERATOR_NUM)
#define ITER_SSTABLE_LEVEL1_INDEX_BUFFER_START_ADDR    (ITER_SSTABLE_LEVEL0_INDEX_BUFFER_START_ADDR + ITER_SSTABLE_LEVEL0_INDEX_BUFFER_SIZE)
#define ITER_SSTABLE_LEVEL1_INDEX_BUFFER_SIZE          (sizeof(struct _SSTABLE_INDEX_NODE) * MAX_SKIPLIST_NODE * 2 * MAX_ITERATOR_NUM)
#define ITER_SSTABLE_LEVEL2_INDEX_BUFFER_START_ADDR    (ITER_SSTABLE_LEVEL1_INDEX_BUFFER_START_ADDR + ITER_SSTABLE_LEVEL1_INDEX_BUFFER_SIZE)
#define ITER_SSTABLE_LEVEL2_INDEX_BUFFER_SIZE          (sizeof(struct _SSTABLE_INDEX_NODE) * MAX_SKIPLIST_NODE * 2 * 2 * MAX_ITERATOR_NUM)
#define ITER_SSTABLE_LEVEL3_INDEX_BUFFER_START_ADDR    (ITER_SSTABLE_LEVEL2_INDEX_BUFFER_START_ADDR + ITER_SSTABLE_LEVEL2_INDEX_BUFFER_SIZE)
#define ITER_SSTABLE_LEVEL3_INDEX_BUFFER_SIZE          (sizeof(struct _SSTABLE_INDEX_NODE) * MAX_SKIPLIST_NODE * 2 * 2 * 2 * MAX_ITERATOR_NUM)

// SSTable Data Buffer for Iterator
#define ITER_SSTABLE_LEVEL0_DATA_BUFFER_START_ADDR    (ITER_SSTABLE_LEVEL3_INDEX_BUFFER_START_ADDR + ITER_SSTABLE_LEVEL3_INDEX_BUFFER_SIZE)
#define ITER_SSTABLE_LEVEL0_DATA_BUFFER_SIZE          (sizeof(struct _SSTABLE_DATA_NODE) * MAX_SKIPLIST_NODE * MAX_SSTABLE_LEVEL0 * MAX_ITERATOR_NUM)
#define ITER_SSTABLE_LEVEL1_DATA_BUFFER_START_ADDR    ITER_SSTABLE_LEVEL0_DATA_BUFFER_START_ADDR + ITER_SSTABLE_LEVEL0_DATA_BUFFER_SIZE
#define ITER_SSTABLE_LEVEL1_DATA_BUFFER_SIZE          (sizeof(struct _SSTABLE_DATA_NODE) * MAX_SKIPLIST_NODE * 2 * MAX_ITERATOR_NUM)
#define ITER_SSTABLE_LEVEL2_DATA_BUFFER_START_ADDR    ITER_SSTABLE_LEVEL1_DATA_BUFFER_START_ADDR + ITER_SSTABLE_LEVEL1_DATA_BUFFER_SIZE
#define ITER_SSTABLE_LEVEL2_DATA_BUFFER_SIZE          (sizeof(struct _SSTABLE_DATA_NODE) * MAX_SKIPLIST_NODE * 2 * 2 * MAX_ITERATOR_NUM)
#define ITER_SSTABLE_LEVEL3_DATA_BUFFER_START_ADDR    ITER_SSTABLE_LEVEL2_DATA_BUFFER_START_ADDR + ITER_SSTABLE_LEVEL2_DATA_BUFFER_SIZE
#define ITER_SSTABLE_LEVEL3_DATA_BUFFER_SIZE          (sizeof(struct _SSTABLE_DATA_NODE) * MAX_SKIPLIST_NODE * 2 * 2 * 2 * MAX_ITERATOR_NUM)

#define TRASH_CAN_ADDR                                (ITER_SSTABLE_LEVEL3_DATA_BUFFER_START_ADDR + ITER_SSTABLE_LEVEL3_DATA_BUFFER_SIZE)
