...
struct STAT_PER_TYPE {
	unsigned int c;				// # of CMDs
	unsigned int found;			// # of found keys
	unsigned int hit;			// # of buffer HITs
	XTime TOTAL_TIME;			// Total time of cmd processing
	XTime NAND_READ_SSTABLE;		// SSTable NAND Read Time
	XTime NAND_READ_LOG;			// Value Log Read Time
	XTime DEVICE_MEMCPY;			// Memcpy Time
	XTime INDEX_SEARCH;			// LSM-Tree Index Search Time
	XTime DMA_BLOCKING;			// DMA Blocking Time
};
