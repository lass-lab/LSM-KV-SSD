...
/*Opcodes for KV-IO Commands*/
#define IO_NVM_KV_PUT										0xA0
#define IO_NVM_KV_GET										0xA1
#define IO_NVM_KV_DELETE									0xA2
#define PRINT_TIME											0xA3
...
typedef struct _auto_cpl_info
{
	unsigned char mark;
	// unsigned short sqid;
	// unsigned short cid;
	unsigned int numOfNvmeBlock;
	unsigned int sentNvmeBlock;
